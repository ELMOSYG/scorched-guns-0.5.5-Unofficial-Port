...
public class ShotgunTurretMenu extends AbstractContainerMenu {
   ...
   public ShotgunTurretMenu(int id, Inventory playerInventory, RegistryFriendlyByteBuf extraData) {
   ...
   public ShotgunTurretMenu(int id, Inventory playerInventory, BlockEntity entity) {
      super((MenuType)ModMenuTypes.SHOTGUN_TURRET_MENU.get(), id);
   ...
   public boolean stillValid(Player player) {
      return stillValid(ContainerLevelAccess.create(this.level, this.pos), player, (Block)ModBlocks.SHOTGUN_TURRET.get());
   }
   ...
   public ShotgunTurretBlockEntity getBlockEntity() {
      return this.level.getBlockEntity(this.pos) instanceof ShotgunTurretBlockEntity turretBlockEntity ? turretBlockEntity : null;
   }
}
