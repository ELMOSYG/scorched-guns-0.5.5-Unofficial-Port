...
public class BasicTurretMenu extends AbstractContainerMenu {
   ...
   public BasicTurretMenu(int id, Inventory playerInventory, RegistryFriendlyByteBuf extraData) {
   ...
   public BasicTurretMenu(int id, Inventory playerInventory, BlockEntity entity) {
      super((MenuType)ModMenuTypes.BASIC_TURRET_MENU.get(), id);
   ...
   public boolean stillValid(Player player) {
      return stillValid(ContainerLevelAccess.create(this.level, this.pos), player, (Block)ModBlocks.BASIC_TURRET.get());
   }
   ...
   public BasicTurretBlockEntity getBlockEntity() {
      return this.level.getBlockEntity(this.pos) instanceof BasicTurretBlockEntity turretBlockEntity ? turretBlockEntity : null;
   }
}
