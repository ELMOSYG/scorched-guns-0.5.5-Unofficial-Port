...
public class PoweredMechanicalPressMenu extends AbstractContainerMenu {
   ...
   public PoweredMechanicalPressMenu(int id, Inventory inv, RegistryFriendlyByteBuf extraData) {
      this(id, inv, inv.player.level().getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(4));
   }

   public PoweredMechanicalPressMenu(int id, Inventory inv, BlockEntity entity, ContainerData data) {
      super((MenuType)ModMenuTypes.POWERED_MECHANICAL_PRESS_MENU.get(), id);
      checkContainerSize(inv, 5);
      this.blockEntity = (PoweredMechanicalPressBlockEntity)entity;
   ...
   public boolean stillValid(Player player) {
      return stillValid(ContainerLevelAccess.create(this.level, this.blockEntity.getBlockPos()), player, (Block)ModBlocks.POWERED_MECHANICAL_PRESS.get());
   }
