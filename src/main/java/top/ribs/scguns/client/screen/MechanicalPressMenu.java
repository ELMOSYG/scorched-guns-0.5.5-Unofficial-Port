...
public class MechanicalPressMenu extends AbstractContainerMenu {
   ...
   public MechanicalPressMenu(int id, Inventory inv, RegistryFriendlyByteBuf extraData) {
   ...
   public boolean stillValid(Player player) {
      return stillValid(ContainerLevelAccess.create(this.level, this.blockEntity.getBlockPos()), player, (Block)ModBlocks.MECHANICAL_PRESS.get());
   }
   ...
   private boolean isMoldItem(ItemStack stack) {
      if (this.level == null) {
         ...
         return recipeManager.getAllRecipesFor(MechanicalPressRecipe.Type.INSTANCE)
            .stream()
