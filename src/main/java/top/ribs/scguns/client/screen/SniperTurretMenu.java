...
public class SniperTurretMenu extends AbstractContainerMenu {
   ...
   public SniperTurretMenu(int id, Inventory playerInventory, RegistryFriendlyByteBuf extraData) {
   ...
   public SniperTurretMenu(int id, Inventory playerInventory, BlockEntity entity) {
      super((MenuType)ModMenuTypes.SNIPER_TURRET_MENU.get(), id);
   ...
   public boolean stillValid(Player player) {
      return stillValid(ContainerLevelAccess.create(this.level, this.pos), player, (Block)ModBlocks.SNIPER_TURRET.get());
   }
   ...
   public SniperTurretBlockEntity getBlockEntity() {
      return this.level.getBlockEntity(this.pos) instanceof SniperTurretBlockEntity turretBlockEntity ? turretBlockEntity : null;
   }
}
