...
public class PolarGeneratorMenu extends AbstractContainerMenu {
   ...
   public PolarGeneratorMenu(int id, Inventory inv, RegistryFriendlyByteBuf extraData) {
   ...
   public boolean stillValid(Player player) {
      return stillValid(ContainerLevelAccess.create(this.level, this.blockEntity.getBlockPos()), player, (Block)ModBlocks.POLAR_GENERATOR.get());
   }
