...
public class InspectHandler {
   ...
   public void onKeyPressed(Key event) {
      ...
      if (player != null) {
         ...
         if (heldItem.getItem() instanceof AnimatedGunItem gunItem && KeyBinds.KEY_INSPECT.isDown() && event.getAction() == 1) {
            ...
            if (animationController != null) {
               ...
               if (animationController.getCurrentAnimation() != null) {
                  ...
                  canInspect = !currentAnim.contains("draw") && !currentAnim.contains("reload") && !AimingHandler.get().isAiming();
               }
