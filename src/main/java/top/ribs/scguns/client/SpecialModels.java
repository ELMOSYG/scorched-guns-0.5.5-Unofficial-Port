...
public enum SpecialModels {
   ...
   private SpecialModels(String modelName) {
      // 1.21 keys side-loaded models by ModelResourceLocation; RegisterAdditional
      // requires the "standalone" variant and the same key is used to look the
      // baked model back up from the model manager.
      this.modelLocation = ModelResourceLocation.standalone(ResourceLocation.fromNamespaceAndPath("scguns", "special/" + modelName));
   }
   ...
   @SubscribeEvent
   public static void onBake(BakingCompleted event) {
      for (SpecialModels model : values()) {
