...
public class MiniGun3Pose extends WeaponPose {
   ...
   public void renderFirstPersonArms(
      ...
      if (!(stack.getItem() instanceof AnimatedGunItem)) {
         ...
         poseStack.translate(0.25 * (double)side, 0.4, 0.0);
         poseStack.translate((double)armWidth / 2.0 * 0.0625 * (double)side, 0.0, 0.0);
         poseStack.translate(-0.25 * (double)side, -0.15, -1.0);
         poseStack.mulPose(Axis.XP.rotationDegrees(110.0F));
         poseStack.mulPose(Axis.YP.rotationDegrees(25.0F * (float)(-side)));
         poseStack.mulPose(Axis.ZP.rotationDegrees(25.0F * (float)(-side)));
         ...
         poseStack.popPose();
         poseStack.pushPose();
         poseStack.translate(0.0, 0.0, -0.675);
         poseStack.scale(0.5F, 0.5F, 0.5F);
