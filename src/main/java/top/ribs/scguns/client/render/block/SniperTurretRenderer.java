...
public class SniperTurretRenderer implements BlockEntityRenderer<SniperTurretBlockEntity> {
   public SniperTurretRenderer(Context context) {
      super();
   }
   ...
   public void render(SniperTurretBlockEntity turret, float partialTicks, PoseStack matrixStack, MultiBufferSource buffer, int light, int overlay) {
      ...
      this.renderTurretTop(
         turret, matrixStack, buffer, light, overlay, SpecialModels.SNIPER_TURRET_TOP.getModel(), 0.5, 1.0, 0.5, interpolatedYaw, interpolatedPitch
      );
   }

   private void renderTurretTop(
      SniperTurretBlockEntity turret,
