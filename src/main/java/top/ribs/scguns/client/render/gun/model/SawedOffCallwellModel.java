...
public class SawedOffCallwellModel implements IOverrideModel {
   public SawedOffCallwellModel() {
      super();
   }
   ...
   public void render(
      ...
      RenderUtil.renderModel(SpecialModels.SAWED_OFF_CALLWELL_MAIN.getModel(), stack, matrixStack, buffer, light, overlay);
