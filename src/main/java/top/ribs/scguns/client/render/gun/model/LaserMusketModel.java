...
public class LaserMusketModel implements IOverrideModel {
   public LaserMusketModel() {
      super();
   }
   ...
   public void render(
      ...
      RenderUtil.renderModel(SpecialModels.LASER_MUSKET_MAIN.getModel(), stack, matrixStack, buffer, light, overlay);
