...
public class PlasmabussModel implements IOverrideModel {
   public PlasmabussModel() {
      super();
   }
   ...
   public void render(
      ...
      RenderUtil.renderModel(SpecialModels.PLASMABUSS_MAIN.getModel(), stack, matrixStack, buffer, light, overlay);
