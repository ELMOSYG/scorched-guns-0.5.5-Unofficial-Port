...
public class NitroKegRenderer extends EntityRenderer<PrimedNitroKeg> {
   ...
   public NitroKegRenderer(Context context) {
      super(context);
   ...
   public void render(PrimedNitroKeg entity, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource buffer, int packedLight) {
      ...
      poseStack.mulPose(Axis.YP.rotationDegrees(90.0F));
      BlockState nitroKegState = ((Block)ModBlocks.NITRO_KEG.get()).defaultBlockState();
      this.renderBlock(nitroKegState, poseStack, buffer, packedLight, fuse / 5 % 2 == 0);
      poseStack.popPose();
