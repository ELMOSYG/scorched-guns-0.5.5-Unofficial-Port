...
public class SulfurDustParticle extends TextureSheetParticle {
   ...
   protected SulfurDustParticle(ClientLevel level, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed, SpriteSet spriteSet) {
   ...
   public void tick() {
      ...
      this.xd = this.xd + (this.random.nextDouble() - 0.5) * 0.01;
      this.zd = this.zd + (this.random.nextDouble() - 0.5) * 0.01;
