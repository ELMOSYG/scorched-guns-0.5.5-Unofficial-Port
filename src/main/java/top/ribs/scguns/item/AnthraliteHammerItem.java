...
public class AnthraliteHammerItem extends PickaxeItem {
   public AnthraliteHammerItem(Tier tier, float attackDamage, Properties properties) {
      // 1.20.1 passed (damageModifier, attackSpeedModifier) to PickaxeItem; 1.21 moved those
      // attributes into the item properties, so build the identical pair here.
      super(tier, properties.attributes(DiggerItem.createAttributes(tier, 1, attackDamage)));
   }
