            ...
            if (player != null) {
               ...
               if (heldItem.getItem() instanceof GunItem gunItem) {
                  ...
                  if (!general.allowsAmmoChange()) {
                     player.sendSystemMessage(Component.translatable("message.scguns.ammo_swap.not_supported").withStyle(ChatFormatting.RED), true);
                  } else if (general.getAvailableAmmoTypes().isEmpty()) {
                     player.sendSystemMessage(Component.translatable("message.scguns.ammo_swap.no_types").withStyle(ChatFormatting.RED), true);
                  } else {
                     ...
                     AmmoContext ammoContext = Gun.findAmmo(player, modifiedGun.getProjectile(heldItem).getItem());
