...
public class S2CMessageGunSound {
   ...
   public S2CMessageGunSound(
      ResourceLocation id, SoundSource category, float x, float y, float z, float volume, float pitch, int shooterId, boolean muzzle, boolean reload
   ) {
      super();
      this.id = id;
   ...
   public S2CMessageGunSound decode(FriendlyByteBuf buffer) {
      ...
      SoundSource category = (SoundSource)buffer.readEnum(SoundSource.class);
