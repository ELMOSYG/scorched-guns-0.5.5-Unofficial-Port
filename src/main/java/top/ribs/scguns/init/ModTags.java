...
public class ModTags {
   ...
   public static class Blocks {
      ...
      private static TagKey<Block> tag(String name) {
         return BlockTags.create(ResourceLocation.fromNamespaceAndPath("scguns", name));
      }

      private static TagKey<Block> tag() {
         return BlockTags.create(ResourceLocation.fromNamespaceAndPath("scguns", "fragile"));
      }
   }
   ...
   public static class Entities {
      ...
      public static TagKey<EntityType<?>> tag(String name) {
         return TagKey.create(Registries.ENTITY_TYPE, ResourceLocation.fromNamespaceAndPath("scguns", name));
      }
   }
   ...
   public static class Items {
      ...
      public static boolean isInTierTag(ItemStack stack, GunTier tier) {
         if (!stack.isEmpty() && tier != null && tier.getTagName() != null) {
            TagKey<Item> tierTag = ItemTags.create(ResourceLocation.fromNamespaceAndPath("scguns", tier.getTagName()));
      ...
      private static TagKey<Item> tag(String name) {
         return ItemTags.create(ResourceLocation.fromNamespaceAndPath("scguns", name));
      }
   }
}
