...
public class ThrowableMolotovCocktailEntity extends ThrowableGrenadeEntity {
   ...
   public ThrowableMolotovCocktailEntity(Level world, LivingEntity entity, int timeLeft) {
      super((EntityType<? extends ThrowableItemEntity>)ModEntities.THROWABLE_MOLOTOV_COCKTAIL.get(), world, entity);
      this.setShouldBounce(false);
      this.setItem(new ItemStack((ItemLike)ModItems.MOLOTOV_COCKTAIL.get()));
      this.setMaxLife(60);
   }
   ...
   public void particleTick() {
      if (this.level().isClientSide) {
         ...
         this.level().addParticle(ParticleTypes.LAVA, true, this.getX(), this.getY() + 0.25, this.getZ(), 0.0, 0.0, 0.0);
      }
   }
