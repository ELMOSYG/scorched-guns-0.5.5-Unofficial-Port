...
public class HardenedBulletProjectileEntity extends ProjectileEntity {
   ...
   public HardenedBulletProjectileEntity(
      ...
      this.canBeReused = this.random.nextFloat() < 0.5F;
   }
   ...
   protected void onHitBlock(BlockState state, BlockPos pos, Direction face, double x, double y, double z) {
      ...
      if (this.canBeReused && !this.level().isClientSide && this.shooter instanceof Player) {
         ...
         itemEntity.setDeltaMovement((this.random.nextDouble() - 0.5) * bounceStrength, 0.15, (this.random.nextDouble() - 0.5) * bounceStrength);
