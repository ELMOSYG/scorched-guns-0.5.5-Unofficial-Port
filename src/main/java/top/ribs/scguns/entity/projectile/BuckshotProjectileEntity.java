...
public class BuckshotProjectileEntity extends ProjectileEntity {
   ...
   public BuckshotProjectileEntity(
   ...
   protected void onHitBlock(BlockState state, BlockPos pos, Direction face, double x, double y, double z) {
      ...
      if (!this.level().isClientSide && this.random.nextFloat() < 0.0F) {
         ItemEntity bulletEntity = new ItemEntity(
            this.level(), this.getX(), this.getY(), this.getZ(), new ItemStack((ItemLike)ModItems.STANDARD_BULLET.get())
         );
