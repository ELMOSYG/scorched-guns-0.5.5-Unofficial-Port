...
public class HornlinModel extends HumanoidModel<HornlinEntity> {
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      PartDefinition head = partdefinition.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            .texOffs(0, 16)
            .addBox(-5.0F, -8.0F, -4.0F, 10.0F, 8.0F, 8.0F, new CubeDeformation(0.0F))
            .texOffs(36, 50)
      ...
      head.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            .texOffs(16, 49)
            .addBox(0.0F, 0.0F, -2.0F, 1.0F, 5.0F, 4.0F, new CubeDeformation(0.0F))
            .texOffs(32, 44)
            .addBox(-1.0F, 3.75F, 0.0F, 3.0F, 3.0F, 0.0F, new CubeDeformation(0.0F)),
      ...
      partdefinition.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            .texOffs(0, 0)
            .addBox(-5.5F, 6.0F, -4.0F, 11.0F, 8.0F, 8.0F, new CubeDeformation(0.2F))
            .texOffs(0, 32)
            .addBox(-5.5F, 14.0F, -4.0F, 11.0F, 4.0F, 8.0F, new CubeDeformation(0.0F))
            .texOffs(36, 16)
            .addBox(-5.0F, 0.0F, -3.5F, 10.0F, 6.0F, 7.0F, new CubeDeformation(0.0F)),
         PartPose.offset(0.0F, 0.0F, 0.0F)
      );
      partdefinition.addOrReplaceChild(
         "right_arm",
         CubeListBuilder.create()
            .texOffs(38, 39)
            .addBox(-5.0F, -1.0F, -2.0F, 5.0F, 6.0F, 5.0F, new CubeDeformation(0.0F))
            .texOffs(0, 44)
            .addBox(-4.0F, 5.0F, -1.25F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.0F))
            .texOffs(16, 44)
            .addBox(-4.0F, -2.0F, -1.25F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)),
      ...
      partdefinition.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            .texOffs(38, 39)
            .mirror()
            .addBox(0.0F, -1.0F, -2.0F, 5.0F, 6.0F, 5.0F, new CubeDeformation(0.0F))
            .mirror(false)
            .texOffs(0, 44)
            .mirror()
            .addBox(0.0F, 5.0F, -1.25F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.0F))
            .mirror(false)
            .texOffs(16, 44)
            .mirror()
            .addBox(0.0F, -2.0F, -1.25F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.0F))
            .mirror(false),
         PartPose.offset(5.0F, 1.0F, 0.0F)
      );
      partdefinition.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            .texOffs(53, 33)
            .addBox(-3.0F, 7.0F, -2.5F, 5.0F, 5.0F, 6.0F, new CubeDeformation(0.0F))
            .texOffs(54, 5)
            .addBox(-3.0F, 1.0F, -3.5F, 5.0F, 6.0F, 7.0F, new CubeDeformation(0.0F)),
      ...
      partdefinition.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            .texOffs(53, 33)
            .mirror()
            .addBox(-2.0F, 7.0F, -2.5F, 5.0F, 5.0F, 6.0F, new CubeDeformation(0.0F))
            .mirror(false)
            .texOffs(54, 5)
            .mirror()
            .addBox(-2.0F, 1.0F, -3.5F, 5.0F, 6.0F, 7.0F, new CubeDeformation(0.0F))
            .mirror(false),
         PartPose.offset(2.0F, 12.0F, 0.0F)
      );
   ...
   public void setupAnim(HornlinEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
      ...
      float earWiggle = (float) (Math.PI / 6);
   ...
   private void animateEating(HornlinEntity entity, float ageInTicks, boolean isEating, boolean isPreparing) {
      if (isPreparing) {
         ...
         this.head.xRot = this.head.xRot + Mth.lerp(progress, 0.0F, 0.15F);
      } else if (isEating) {
         ...
         this.head.xRot = this.head.xRot + 0.15F + Mth.sin(ageInTicks * 0.35F) * 0.05F;
