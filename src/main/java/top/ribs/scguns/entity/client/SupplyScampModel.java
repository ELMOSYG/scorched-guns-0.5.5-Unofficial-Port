...
public class SupplyScampModel<T extends Entity> extends HierarchicalModel<T> {
   ...
   public void setupAnim(@NotNull T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
      ...
      if (entity instanceof SupplyScampEntity supplyScamp) {
         ...
         if (maskColor >= 0 && maskColor < this.masks.length) {
            this.masks[maskColor].visible = supplyScamp.isTame();
         }
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      PartDefinition SupplyScamp = partdefinition.addOrReplaceChild(
         "SupplyScamp", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, 24.0F, 0.0F, 0.0F, 1.5708F, 0.0F)
      );
      PartDefinition tread = SupplyScamp.addOrReplaceChild(
         "tread",
         CubeListBuilder.create()
            .texOffs(48, 69)
            .addBox(-8.5F, 7.0F, -7.0F, 1.0F, 3.0F, 14.0F, new CubeDeformation(0.0F))
            .texOffs(0, 21)
            .addBox(-6.5F, 5.0F, -8.0F, 3.0F, 5.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(8, 13)
            .addBox(4.5F, 5.0F, 7.0F, 3.0F, 5.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(10, 0)
            .addBox(-6.5F, 5.0F, 7.0F, 3.0F, 5.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(0, 40)
            .addBox(-7.5F, 6.0F, -7.0F, 16.0F, 5.0F, 14.0F, new CubeDeformation(0.0F))
            .texOffs(32, 59)
            .addBox(8.5F, 7.0F, -7.0F, 1.0F, 3.0F, 14.0F, new CubeDeformation(0.0F))
            .texOffs(0, 10)
            .addBox(4.5F, 5.0F, -8.0F, 3.0F, 5.0F, 1.0F, new CubeDeformation(0.0F)),
      ...
      PartDefinition body_r1 = body.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            ...
            .texOffs(24, 59)
            .addBox(-2.0F, -9.75F, 4.0F, 4.0F, 1.0F, 7.0F, new CubeDeformation(0.0F))
            .texOffs(64, 69)
            .addBox(-8.0F, -15.75F, -7.0F, 1.0F, 3.0F, 11.0F, new CubeDeformation(0.0F))
            .texOffs(9, 9)
            .addBox(-2.0F, -20.75F, -8.0F, 4.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(8, 21)
            ...
            .texOffs(0, 75)
            .addBox(7.0F, -15.75F, -7.0F, 1.0F, 3.0F, 11.0F, new CubeDeformation(0.0F))
            .texOffs(54, 35)
            .addBox(-2.0F, -20.75F, -7.0F, 4.0F, 1.0F, 12.0F, new CubeDeformation(0.0F))
            .texOffs(74, 35)
            .addBox(-2.0F, -17.75F, 4.0F, 4.0F, 1.0F, 7.0F, new CubeDeformation(0.0F))
            .texOffs(7, 26)
            .addBox(-2.0F, -19.75F, 4.0F, 4.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(49, 21)
            .addBox(-6.0F, -16.75F, 4.0F, 12.0F, 7.0F, 7.0F, new CubeDeformation(0.0F))
            .texOffs(49, 48)
            .addBox(-7.0F, -19.75F, -7.0F, 14.0F, 10.0F, 11.0F, new CubeDeformation(0.0F))
            .texOffs(0, 21)
            .addBox(-8.0F, -9.75F, -8.0F, 16.0F, 2.0F, 17.0F, new CubeDeformation(0.0F))
            .texOffs(0, 0)
            .addBox(-8.0F, -7.75F, -9.0F, 16.0F, 2.0F, 19.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(1.0F, -4.0F, 0.0F, 0.0F, -1.5708F, 0.0F)
      );
      PartDefinition body_r2 = body.addOrReplaceChild(
         "body_r2",
         CubeListBuilder.create().texOffs(8, 29).addBox(6.0F, -15.75F, 6.0F, 2.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(-10.0F, -4.0F, 0.0F, 0.0F, 1.5708F, 0.0F)
      );
      PartDefinition body_r3 = body.addOrReplaceChild(
         "body_r3",
         CubeListBuilder.create().texOffs(0, 32).addBox(6.0F, -15.75F, -7.0F, 2.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(-10.0F, -4.0F, 0.0F, 0.0F, -1.5708F, 0.0F)
      );
      PartDefinition body_r4 = body.addOrReplaceChild(
         "body_r4",
         CubeListBuilder.create().texOffs(0, 0).addBox(-2.0F, -17.75F, 12.0F, 4.0F, 9.0F, 1.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(2.0F, -4.0F, 0.0F, 0.0F, -1.5708F, 0.0F)
      );
      PartDefinition head = body.addOrReplaceChild(
         "head",
         CubeListBuilder.create().texOffs(0, 59).addBox(-4.0F, -4.25F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F)),
         PartPose.offset(7.0F, -17.25F, 0.0F)
      );
      PartDefinition MaskBlack = head.addOrReplaceChild("MaskBlack", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));
      PartDefinition head_r1 = MaskBlack.addOrReplaceChild(
         "head_r1",
         CubeListBuilder.create().texOffs(13, 67).addBox(-0.2F, -3.75F, -4.0F, 0.0F, 7.0F, 8.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(4.25F, -0.25F, 0.0F, 0.1309F, 0.0F, 0.0F)
      );
      PartDefinition MaskPink = head.addOrReplaceChild("MaskPink", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));
      PartDefinition head_r2 = MaskPink.addOrReplaceChild(
         "head_r2",
         CubeListBuilder.create().texOffs(13, 81).addBox(-0.2F, -3.75F, -4.0F, 0.0F, 7.0F, 8.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(4.25F, -0.25F, 0.0F, 0.1309F, 0.0F, 0.0F)
      );
      PartDefinition MaskPurple = head.addOrReplaceChild("MaskPurple", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));
      PartDefinition head_r3 = MaskPurple.addOrReplaceChild(
         "head_r3",
         CubeListBuilder.create().texOffs(13, 88).addBox(-0.2F, -3.75F, -4.0F, 0.0F, 7.0F, 8.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(4.25F, -0.25F, 0.0F, 0.1309F, 0.0F, 0.0F)
      );
      PartDefinition MaskBlue = head.addOrReplaceChild("MaskBlue", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));
      PartDefinition head_r4 = MaskBlue.addOrReplaceChild(
         "head_r4",
         CubeListBuilder.create().texOffs(29, 81).addBox(-0.2F, -3.75F, -4.0F, 0.0F, 7.0F, 8.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(4.25F, -0.25F, 0.0F, 0.1309F, 0.0F, 0.0F)
      );
      PartDefinition MaskRed = head.addOrReplaceChild("MaskRed", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));
      PartDefinition head_r5 = MaskRed.addOrReplaceChild(
         "head_r5",
         CubeListBuilder.create().texOffs(13, 95).addBox(-0.2F, -3.75F, -4.0F, 0.0F, 7.0F, 8.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(4.25F, -0.25F, 0.0F, 0.1309F, 0.0F, 0.0F)
      );
      PartDefinition MaskMagenta = head.addOrReplaceChild("MaskMagenta", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));
      PartDefinition head_r6 = MaskMagenta.addOrReplaceChild(
         "head_r6",
         CubeListBuilder.create().texOffs(13, 109).addBox(-0.2F, -3.75F, -4.0F, 0.0F, 7.0F, 8.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(4.25F, -0.25F, 0.0F, 0.1309F, 0.0F, 0.0F)
      );
      PartDefinition MaskGreen = head.addOrReplaceChild("MaskGreen", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));
      PartDefinition head_r7 = MaskGreen.addOrReplaceChild(
         "head_r7",
         CubeListBuilder.create().texOffs(13, 102).addBox(-0.2F, -3.75F, -4.0F, 0.0F, 7.0F, 8.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(4.25F, -0.25F, 0.0F, 0.1309F, 0.0F, 0.0F)
      );
      PartDefinition MaskLightGreen = head.addOrReplaceChild("MaskLime", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));
      PartDefinition head_r8 = MaskLightGreen.addOrReplaceChild(
         "head_r8",
         CubeListBuilder.create().texOffs(29, 88).addBox(-0.2F, -3.75F, -4.0F, 0.0F, 7.0F, 8.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(4.25F, -0.25F, 0.0F, 0.1309F, 0.0F, 0.0F)
      );
      PartDefinition MaskBrown = head.addOrReplaceChild("MaskBrown", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));
      PartDefinition head_r9 = MaskBrown.addOrReplaceChild(
         "head_r9",
         CubeListBuilder.create().texOffs(29, 95).addBox(-0.2F, -3.75F, -4.0F, 0.0F, 7.0F, 8.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(4.25F, -0.25F, 0.0F, 0.1309F, 0.0F, 0.0F)
      );
      PartDefinition MaskGray = head.addOrReplaceChild("MaskGray", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));
      PartDefinition head_r10 = MaskGray.addOrReplaceChild(
         "head_r10",
         CubeListBuilder.create().texOffs(29, 102).addBox(-0.2F, -3.75F, -4.0F, 0.0F, 7.0F, 8.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(4.25F, -0.25F, 0.0F, 0.1309F, 0.0F, 0.0F)
      );
      PartDefinition MaskLightGray = head.addOrReplaceChild("MaskLightGray", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));
      PartDefinition head_r11 = MaskLightGray.addOrReplaceChild(
         "head_r11",
         CubeListBuilder.create().texOffs(29, 109).addBox(-0.2F, -3.75F, -4.0F, 0.0F, 7.0F, 8.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(4.25F, -0.25F, 0.0F, 0.1309F, 0.0F, 0.0F)
      );
      PartDefinition MaskYellow = head.addOrReplaceChild("MaskYellow", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));
      PartDefinition head_r12 = MaskYellow.addOrReplaceChild(
         "head_r12",
         CubeListBuilder.create().texOffs(45, 109).addBox(-0.2F, -3.75F, -4.0F, 0.0F, 7.0F, 8.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(4.25F, -0.25F, 0.0F, 0.1309F, 0.0F, 0.0F)
      );
      PartDefinition MaskCyan = head.addOrReplaceChild("MaskCyan", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));
      PartDefinition head_r13 = MaskCyan.addOrReplaceChild(
         "head_r13",
         CubeListBuilder.create().texOffs(45, 102).addBox(-0.2F, -3.75F, -4.0F, 0.0F, 7.0F, 8.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(4.25F, -0.25F, 0.0F, 0.1309F, 0.0F, 0.0F)
      );
      PartDefinition MaskLightBlue = head.addOrReplaceChild("MaskLightBlue", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));
      PartDefinition head_r14 = MaskLightBlue.addOrReplaceChild(
         "head_r14",
         CubeListBuilder.create().texOffs(45, 95).addBox(-0.2F, -3.75F, -4.0F, 0.0F, 7.0F, 8.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(4.25F, -0.25F, 0.0F, 0.1309F, 0.0F, 0.0F)
      );
      PartDefinition MaskWhite = head.addOrReplaceChild("MaskWhite", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));
      PartDefinition head_r15 = MaskWhite.addOrReplaceChild(
         "head_r15",
         CubeListBuilder.create().texOffs(45, 88).addBox(-0.2F, -3.75F, -4.0F, 0.0F, 7.0F, 8.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(4.25F, -0.25F, 0.0F, 0.1309F, 0.0F, 0.0F)
      );
      PartDefinition MaskOrange = head.addOrReplaceChild("MaskOrange", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));
      PartDefinition head_r16 = MaskOrange.addOrReplaceChild(
         "head_r16",
         CubeListBuilder.create().texOffs(45, 81).addBox(-0.2F, -3.75F, -4.0F, 0.0F, 7.0F, 8.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(4.25F, -0.25F, 0.0F, 0.1309F, 0.0F, 0.0F)
      );
      PartDefinition Cog = body.addOrReplaceChild("Cog", CubeListBuilder.create(), PartPose.offset(2.0F, -25.96F, 0.0F));
      PartDefinition cube_r1 = Cog.addOrReplaceChild(
         "cube_r1",
         CubeListBuilder.create().texOffs(46, 40).addBox(-1.0F, -4.0F, -1.0F, 2.0F, 8.0F, 2.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(0.0F, 0.06F, 0.0F, 0.7854F, 0.0F, 1.5708F)
      );
      PartDefinition cube_r2 = Cog.addOrReplaceChild(
         "cube_r2",
         CubeListBuilder.create().texOffs(0, 40).addBox(-1.0F, -4.0F, -1.0F, 2.0F, 8.0F, 2.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(0.0F, 0.06F, 0.0F, -0.7854F, 0.0F, 1.5708F)
      );
      PartDefinition cube_r3 = Cog.addOrReplaceChild(
         "cube_r3",
         CubeListBuilder.create().texOffs(46, 40).addBox(-1.0F, -4.0F, -1.0F, 2.0F, 8.0F, 2.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(0.0F, -0.04F, 0.0F, 1.5708F, 0.0F, 1.5708F)
      );
      PartDefinition cube_r4 = Cog.addOrReplaceChild(
         "cube_r4",
         CubeListBuilder.create()
            .texOffs(6, 33)
         ...
         PartPose.offsetAndRotation(0.0F, -0.04F, 0.0F, 0.0F, 0.0F, 1.5708F)
      );
