...
public class SulfurheadRenderer extends MobRenderer<SulfurheadEntity, SulfurheadModel<SulfurheadEntity>> {
   public SulfurheadRenderer(Context pContext) {
      ...
      this.addLayer(new SulfurheadRenderer.SulfurheadPrimeOverlayLayer(this));
   }

   public ResourceLocation getTextureLocation(SulfurheadEntity pEntity) {
      return ResourceLocation.fromNamespaceAndPath("scguns", "textures/entity/sulfurhead.png");
   }

   public void render(SulfurheadEntity pEntity, float pEntityYaw, float pPartialTicks, PoseStack pMatrixStack, MultiBufferSource pBuffer, int pPackedLight) {
   ...
   static class SulfurheadPrimeOverlayLayer extends RenderLayer<SulfurheadEntity, SulfurheadModel<SulfurheadEntity>> {
      private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath("scguns", "textures/entity/sulfurhead.png");
      ...
      public void render(
         ...
         if (entity.isPrimed()) {
            ...
            if ((int)(swell * 10.0F) % 2 != 0 && swell > 0.01F) {
               ...
               ((SulfurheadModel)this.getParentModel())
                  .renderToBuffer(poseStack, vertexConsumer, packedLight, LivingEntityRenderer.getOverlayCoords(entity, 0.0F), FastColor.ARGB32.colorFromFloat(0.7F, 1.0F, intensity * 0.8F, 0.2F));
            }
         }
      }
   }
