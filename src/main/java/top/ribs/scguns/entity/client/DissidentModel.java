...
public class DissidentModel<T extends Entity> extends HierarchicalModel<T> {
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      PartDefinition body = partdefinition.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            .texOffs(31, 32)
            .addBox(-6.0F, -5.875F, -3.75F, 12.0F, 2.0F, 11.0F, new CubeDeformation(0.0F))
            .texOffs(0, 0)
            .addBox(-7.0F, -3.875F, -6.75F, 14.0F, 13.0F, 10.0F, new CubeDeformation(0.0F))
            .texOffs(34, 55)
            .addBox(-2.0F, -1.875F, -8.75F, 4.0F, 5.0F, 2.0F, new CubeDeformation(0.0F))
            .texOffs(0, 23)
            .addBox(-6.0F, -3.875F, 3.25F, 12.0F, 11.0F, 9.0F, new CubeDeformation(0.0F)),
         PartPose.offset(0.0F, 0.625F, 1.25F)
      );
      PartDefinition seal_2 = body.addOrReplaceChild(
         "seal_2",
         CubeListBuilder.create().texOffs(0, 0).addBox(-0.125F, 0.45F, -1.5F, 0.0F, 7.0F, 3.0F, new CubeDeformation(0.0F)),
         PartPose.offset(7.375F, 4.925F, -1.25F)
      );
      PartDefinition bone3_r1 = seal_2.addOrReplaceChild(
         "bone3_r1",
         CubeListBuilder.create().texOffs(38, 0).addBox(-0.5F, -1.5F, -1.5F, 1.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(0.125F, -0.05F, 0.0F, 0.7854F, 0.0F, 0.0F)
      );
      PartDefinition seal_1 = body.addOrReplaceChild("seal_1", CubeListBuilder.create(), PartPose.offset(-7.375F, -1.125F, 1.75F));
      PartDefinition bone2_r1 = seal_1.addOrReplaceChild(
         "bone2_r1",
         CubeListBuilder.create().texOffs(38, 0).addBox(-0.5F, -1.5F, -1.5F, 1.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(0.125F, 0.0F, 0.0F, 2.3562F, 0.0F, 3.1416F)
      );
      PartDefinition bone2_r2 = seal_1.addOrReplaceChild(
         "bone2_r2",
         CubeListBuilder.create().texOffs(0, 0).addBox(0.125F, -1.0F, -1.5F, 0.0F, 7.0F, 3.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(0.0F, 1.75F, 0.0F, 0.0F, 3.1416F, 0.0F)
      );
      PartDefinition head = partdefinition.addOrReplaceChild(
         "head",
         CubeListBuilder.create()
            .texOffs(22, 45)
            .addBox(-4.0F, -5.9667F, -3.9667F, 8.0F, 6.0F, 4.0F, new CubeDeformation(0.0F))
            .texOffs(33, 25)
            .addBox(-3.5F, -0.0667F, -4.0667F, 7.0F, 3.0F, 4.0F, new CubeDeformation(-0.1F))
            .texOffs(0, 23)
            .addBox(-1.0F, -1.4667F, -4.4667F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)),
         PartPose.offset(0.0F, 1.4667F, -5.5333F)
      );
      PartDefinition jaw = head.addOrReplaceChild(
         "jaw",
         CubeListBuilder.create()
            .texOffs(39, 14)
            .addBox(-4.0F, -0.0357F, -8.9062F, 8.0F, 2.0F, 9.0F, new CubeDeformation(0.0F))
            .texOffs(4, 0)
            .addBox(-3.75F, -2.0357F, -7.699F, 0.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(2, 0)
            .addBox(-3.75F, -2.0357F, -5.449F, 0.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(0, 0)
            .addBox(-3.75F, -2.0357F, -3.649F, 0.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(0, 0)
            .addBox(3.75F, -2.0357F, -3.649F, 0.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(2, 0)
            .addBox(3.75F, -2.0357F, -5.449F, 0.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(4, 0)
            .addBox(3.75F, -2.0357F, -7.699F, 0.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(0.0F, 3.1761F, -0.1131F, 0.3927F, 0.0F, 0.0F)
      );
      PartDefinition tongue_1 = jaw.addOrReplaceChild(
         "tongue_1",
         CubeListBuilder.create().texOffs(58, 28).addBox(-1.55F, -1.0F, 0.5F, 3.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
         PartPose.offset(0.05F, -0.8916F, -1.8211F)
      );
      PartDefinition tongue_r1_r1 = tongue_1.addOrReplaceChild(
         "tongue_r1_r1",
         CubeListBuilder.create().texOffs(38, 0).addBox(-2.0F, -1.0F, -4.0F, 4.0F, 2.0F, 8.0F, new CubeDeformation(0.1F)),
         PartPose.offsetAndRotation(0.0F, 0.0F, -3.25F, 0.0F, 0.0F, -3.1416F)
      );
      PartDefinition tongue_2 = tongue_1.addOrReplaceChild(
         "tongue_2",
         CubeListBuilder.create().texOffs(55, 25).addBox(-1.5F, -1.0F, -4.6414F, 3.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(-0.05F, 0.0F, -7.0F, 0.3927F, 0.0F, 0.0F)
      );
      ...
      PartDefinition tongue2_r1_r1 = tongue_3.addOrReplaceChild(
         "tongue2_r1_r1",
         CubeListBuilder.create().texOffs(54, 0).addBox(-1.5F, -0.9459F, -2.6307F, 3.0F, 2.0F, 5.0F, new CubeDeformation(-0.2F)),
         PartPose.offsetAndRotation(0.0F, 0.0F, -2.0F, 0.0F, 0.0F, -3.1416F)
      );
      PartDefinition back_right_leg = partdefinition.addOrReplaceChild(
         "back_right_leg",
         CubeListBuilder.create().texOffs(18, 55).addBox(-3.175F, 5.25F, -0.75F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)),
         PartPose.offset(-4.5F, 6.75F, 10.0F)
      );
      PartDefinition back_right_leg_r1 = back_right_leg.addOrReplaceChild(
         "back_right_leg_r1",
         CubeListBuilder.create().texOffs(0, 43).addBox(-2.5F, -4.5F, -3.0F, 5.0F, 9.0F, 6.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(-1.75F, 1.75F, 0.25F, 0.3927F, 0.0F, 0.0F)
      );
      PartDefinition back_left_leg = partdefinition.addOrReplaceChild(
         "back_left_leg",
         CubeListBuilder.create()
            .texOffs(18, 55)
            .mirror()
            .addBox(-0.825F, 5.25F, -0.75F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F))
            .mirror(false),
         PartPose.offset(4.5F, 6.75F, 10.0F)
      );
      PartDefinition back_left_leg_r1 = back_left_leg.addOrReplaceChild(
         "back_left_leg_r1",
         CubeListBuilder.create().texOffs(0, 43).mirror().addBox(-2.5F, -4.5F, -3.0F, 5.0F, 9.0F, 6.0F, new CubeDeformation(0.0F)).mirror(false),
         PartPose.offsetAndRotation(1.75F, 1.75F, 0.25F, 0.3927F, 0.0F, 0.0F)
      );
      ...
      PartDefinition back_right_leg_r2 = front_right_leg.addOrReplaceChild(
         "back_right_leg_r2",
         CubeListBuilder.create().texOffs(58, 58).addBox(-2.5F, -3.0F, -2.0F, 5.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(-6.25F, 1.5021F, -1.6118F, 0.3927F, 0.0F, 0.0F)
      );
      PartDefinition back_right_leg_r3 = front_right_leg.addOrReplaceChild(
         "back_right_leg_r3",
         CubeListBuilder.create().texOffs(46, 45).addBox(-7.725F, -6.5F, -2.0F, 4.0F, 13.0F, 4.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(0.0F, 10.25F, -2.35F, -0.2182F, 0.0F, 0.0F)
      );
      ...
      PartDefinition back_left_leg_r2 = front_left_leg.addOrReplaceChild(
         "back_left_leg_r2",
         CubeListBuilder.create().texOffs(58, 58).mirror().addBox(-2.5F, -3.0F, -2.0F, 5.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false),
         PartPose.offsetAndRotation(6.25F, 1.5021F, -1.6118F, 0.3927F, 0.0F, 0.0F)
      );
      PartDefinition back_left_leg_r3 = front_left_leg.addOrReplaceChild(
         "back_left_leg_r3",
         CubeListBuilder.create()
            .texOffs(46, 45)
            .mirror()
            .addBox(3.725F, -6.5F, -2.0F, 4.0F, 13.0F, 4.0F, new CubeDeformation(0.0F))
            .mirror(false),
         PartPose.offsetAndRotation(0.0F, 10.25F, -2.35F, -0.2182F, 0.0F, 0.0F)
      );
   ...
   public void setupAnim(Entity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
      if (entity instanceof DissidentEntity dissident) {
         ...
         if (isLeaping) {
            ...
            this.body.zRot = this.body.zRot + Mth.cos(limbSwing * walkSpeed * 0.5F) * 0.02F * limbSwingAmount;
         }
         ...
         if (dissident.isAttacking() && dissident.attackAnimationTimeout > 0) {
            ...
            if (!isLeaping && !isLanding) {
               this.jaw.xRot = this.jaw.xRot + Mth.sin(ageInTicks * 0.04F) * 0.02F;
            }
         }
   ...
   public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int color) {
      ...
      this.back_right_leg.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
      this.back_left_leg.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
      this.front_right_leg.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
      this.front_left_leg.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
   }
