...
public record NiterPatchConfiguration(Block niterBlock, int minLayers, int maxLayers, int spreadRadius, int spreadAttempts) implements FeatureConfiguration {
   public static final Codec<NiterPatchConfiguration> CODEC = RecordCodecBuilder.create(
   ...
   public NiterPatchConfiguration(Block niterBlock, int minLayers, int maxLayers, int spreadRadius, int spreadAttempts) {
      this.niterBlock = niterBlock;
