...
public class DynamicHeadshotBox<T extends LivingEntity> implements IHeadshotBox<T> {
   ...
   public AABB getHeadshotBox(T entity) {
      if (entity == null) {
         ...
         double entityWidth = (double)entity.getBbWidth();
         double entityHeight = (double)entity.getBbHeight();
   ...
   private static <T extends LivingEntity> AABB getHeadBox(T entity, double headSizePixels, double eyeHeight) {
      ...
      headBox = headBox.move(0.0, headBottom, 0.0);
      if (entity.isBaby()) {
